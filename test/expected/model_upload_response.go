...
type UploadResponse struct {
	...
	// SchemaErrors:
	SchemaErrors *FieldErrorResponse `json:"schemaErrors"`
	// TargetSchema:
	TargetSchema *ManagedTableSchema `json:"targetSchema"`
	// UploadedBytes:
...
func (m UploadResponse) GetSchemaErrors() *FieldErrorResponse {
	return m.SchemaErrors
}

// SetSchemaErrors sets the SchemaErrors property
func (m UploadResponse) SetSchemaErrors(val *FieldErrorResponse) {
	m.SchemaErrors = val
}

// GetTargetSchema returns the TargetSchema property
func (m UploadResponse) GetTargetSchema() *ManagedTableSchema {
	return m.TargetSchema
}

// SetTargetSchema sets the TargetSchema property
func (m UploadResponse) SetTargetSchema(val *ManagedTableSchema) {
	m.TargetSchema = val
}
