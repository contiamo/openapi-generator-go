...
// UseCaseActions is an object. List of actions allowed to perform on the use case
type UseCaseActions struct {
	// Delete: If true the user is allowed to delete the use case
	...
	// Read: If true the user is allowed to read the use case and its connections/links
	Read bool `json:"read"`
...
func (m UseCaseActions) GetDelete() bool {
	return m.Delete
}

// SetDelete sets the Delete property
func (m UseCaseActions) SetDelete(val bool) {
	m.Delete = val
}

// GetEditMetadata returns the EditMetadata property
func (m UseCaseActions) GetEditMetadata() bool {
	return m.EditMetadata
}

// SetEditMetadata sets the EditMetadata property
func (m UseCaseActions) SetEditMetadata(val bool) {
	m.EditMetadata = val
}

// GetGrant returns the Grant property
func (m UseCaseActions) GetGrant() bool {
	return m.Grant
}

// SetGrant sets the Grant property
func (m UseCaseActions) SetGrant(val bool) {
	m.Grant = val
}

// GetRead returns the Read property
func (m UseCaseActions) GetRead() bool {
	return m.Read
}

// SetRead sets the Read property
func (m UseCaseActions) SetRead(val bool) {
	m.Read = val
}

// GetRole returns the Role property
func (m UseCaseActions) GetRole() string {
	return m.Role
}

// SetRole sets the Role property
func (m UseCaseActions) SetRole(val string) {
	m.Role = val
}
