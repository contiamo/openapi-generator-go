...
// BIReportActions is an object. List of actions allowed to perform on the BI Report
type BIReportActions struct {
	// Delete: If true the user is allowed to delete the BI Report
	Delete bool `json:"delete"`
	// EditMetadata: If true the user is allowed to edit the metadata of the resource
	EditMetadata bool `json:"editMetadata"`
	// Grant: If true the user is allowed to grant permissions for the use case to other users
	Grant bool `json:"grant"`
	// Read: If true the user is allowed to read the BI Report and its connections/links
	Read bool `json:"read"`
...
func (m BIReportActions) GetDelete() bool {
	return m.Delete
}

// SetDelete sets the Delete property
func (m BIReportActions) SetDelete(val bool) {
	m.Delete = val
}

// GetEditMetadata returns the EditMetadata property
func (m BIReportActions) GetEditMetadata() bool {
	return m.EditMetadata
}

// SetEditMetadata sets the EditMetadata property
func (m BIReportActions) SetEditMetadata(val bool) {
	m.EditMetadata = val
}

// GetGrant returns the Grant property
func (m BIReportActions) GetGrant() bool {
	return m.Grant
}

// SetGrant sets the Grant property
func (m BIReportActions) SetGrant(val bool) {
	m.Grant = val
}

// GetRead returns the Read property
func (m BIReportActions) GetRead() bool {
	return m.Read
}

// SetRead sets the Read property
func (m BIReportActions) SetRead(val bool) {
	m.Read = val
}

// GetRole returns the Role property
func (m BIReportActions) GetRole() string {
	return m.Role
}

// SetRole sets the Role property
func (m BIReportActions) SetRole(val string) {
	m.Role = val
}
