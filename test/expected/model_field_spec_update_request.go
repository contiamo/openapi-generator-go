...
// FieldSpecUpdateRequest is an object.
type FieldSpecUpdateRequest struct {
...
func (m FieldSpecUpdateRequest) GetDescription() string {
	return m.Description
}

// SetDescription sets the Description property
func (m FieldSpecUpdateRequest) SetDescription(val string) {
	m.Description = val
}

// GetDisplayName returns the DisplayName property
func (m FieldSpecUpdateRequest) GetDisplayName() string {
	return m.DisplayName
}

// SetDisplayName sets the DisplayName property
func (m FieldSpecUpdateRequest) SetDisplayName(val string) {
	m.DisplayName = val
}

// GetFilterable returns the Filterable property
func (m FieldSpecUpdateRequest) GetFilterable() bool {
	return m.Filterable
}

// SetFilterable sets the Filterable property
func (m FieldSpecUpdateRequest) SetFilterable(val bool) {
	m.Filterable = val
}

// GetKind returns the Kind property
func (m FieldSpecUpdateRequest) GetKind() FieldKind {
	return m.Kind
}

// SetKind sets the Kind property
func (m FieldSpecUpdateRequest) SetKind(val FieldKind) {
	m.Kind = val
}

// GetMaxValue returns the MaxValue property
func (m FieldSpecUpdateRequest) GetMaxValue() *float32 {
	return m.MaxValue
}

// SetMaxValue sets the MaxValue property
func (m FieldSpecUpdateRequest) SetMaxValue(val *float32) {
	m.MaxValue = val
}

// GetMinValue returns the MinValue property
func (m FieldSpecUpdateRequest) GetMinValue() *float32 {
	return m.MinValue
}

// SetMinValue sets the MinValue property
func (m FieldSpecUpdateRequest) SetMinValue(val *float32) {
	m.MinValue = val
}

// GetName returns the Name property
func (m FieldSpecUpdateRequest) GetName() string {
	return m.Name
}

// SetName sets the Name property
func (m FieldSpecUpdateRequest) SetName(val string) {
	m.Name = val
}

// GetSearchable returns the Searchable property
func (m FieldSpecUpdateRequest) GetSearchable() bool {
	return m.Searchable
}

// SetSearchable sets the Searchable property
func (m FieldSpecUpdateRequest) SetSearchable(val bool) {
	m.Searchable = val
}

// GetType returns the Type property
func (m FieldSpecUpdateRequest) GetType() FieldType {
	return m.Type
}

// SetType sets the Type property
func (m FieldSpecUpdateRequest) SetType(val FieldType) {
	m.Type = val
}

// GetValidValues returns the ValidValues property
func (m FieldSpecUpdateRequest) GetValidValues() []string {
	return m.ValidValues
}

// SetValidValues sets the ValidValues property
func (m FieldSpecUpdateRequest) SetValidValues(val []string) {
	m.ValidValues = val
}
