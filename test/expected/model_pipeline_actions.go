...
// PipelineActions is an object. List of actions allowed to perform on the pipeline
...
func (m PipelineActions) GetDelete() bool {
	return m.Delete
}

// SetDelete sets the Delete property
func (m PipelineActions) SetDelete(val bool) {
	m.Delete = val
}

// GetEditMetadata returns the EditMetadata property
func (m PipelineActions) GetEditMetadata() bool {
	return m.EditMetadata
}

// SetEditMetadata sets the EditMetadata property
func (m PipelineActions) SetEditMetadata(val bool) {
	m.EditMetadata = val
}

// GetGrant returns the Grant property
func (m PipelineActions) GetGrant() bool {
	return m.Grant
}

// SetGrant sets the Grant property
func (m PipelineActions) SetGrant(val bool) {
	m.Grant = val
}

// GetRead returns the Read property
func (m PipelineActions) GetRead() bool {
	return m.Read
}

// SetRead sets the Read property
func (m PipelineActions) SetRead(val bool) {
	m.Read = val
}

// GetRole returns the Role property
func (m PipelineActions) GetRole() string {
	return m.Role
}

// SetRole sets the Role property
func (m PipelineActions) SetRole(val string) {
	m.Role = val
}
