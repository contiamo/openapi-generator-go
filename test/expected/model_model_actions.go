...
// ModelActions is an object. List of actions allowed to perform on the model
...
func (m ModelActions) GetDelete() bool {
	return m.Delete
}

// SetDelete sets the Delete property
func (m ModelActions) SetDelete(val bool) {
	m.Delete = val
}

// GetEditMetadata returns the EditMetadata property
func (m ModelActions) GetEditMetadata() bool {
	return m.EditMetadata
}

// SetEditMetadata sets the EditMetadata property
func (m ModelActions) SetEditMetadata(val bool) {
	m.EditMetadata = val
}

// GetGrant returns the Grant property
func (m ModelActions) GetGrant() bool {
	return m.Grant
}

// SetGrant sets the Grant property
func (m ModelActions) SetGrant(val bool) {
	m.Grant = val
}

// GetRead returns the Read property
func (m ModelActions) GetRead() bool {
	return m.Read
}

// SetRead sets the Read property
func (m ModelActions) SetRead(val bool) {
	m.Read = val
}

// GetRole returns the Role property
func (m ModelActions) GetRole() string {
	return m.Role
}

// SetRole sets the Role property
func (m ModelActions) SetRole(val string) {
	m.Role = val
}
